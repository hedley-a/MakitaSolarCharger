...
unsigned long previousMillis = 0;  // will store last time BMS was polled

// constants won't change:
const long interval = 3000;  // interval at which to poll BMS (milliseconds)
